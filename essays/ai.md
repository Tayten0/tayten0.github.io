...
layout: essay
type: essay
title: "You Should Use AI—Just Not Too Much!"
...
<img src="../img/ai/gemini.png" width="400" alt="The Google Gemini Logo.">  
<caption><small>
...
<img src="../img/ai/thinking.jpg" width="400" alt="A Man Thinking.">  
<caption><small>
...
Aside from using Gemini to understand key concepts, write example code, and debug, I also used it to write replacement code for sections that were throwing errors. This was especially true for my final project, where I relied on Gemini whenever something broke—particularly with the Prisma database code. For example, I'd ask, "Please identify the error in this code: &lt;Broken Code&gt; and fix it." Gemini would provide small snippets to resolve the issues, which I'd then incorporate into my project. Most of these problems were caused by minor syntax mistakes, like a missing bracket or parenthesis, though I occasionally ran into critical logic errors I had missed. Without Gemini, many features of my final project would've remained broken.
...
I did use AI to help debug my code, which I've already covered extensively in other subtopics in this section. However, I didn't use Gemini to fix ESLint errors because most of them were easy enough to handle on my own. Extra whitespace and variables of type "any" are the only errors I can recall off the top of my head, but hopefully, the straightforward nature of those errors gives you an idea of why I didn't feel the need to use AI to resolve them.
...
<img src="../img/ai/teacher.webp" width="400" alt="A Teacher Helping a Student.">  
<caption><small>
...
<img src="../img/ai/squinting-meme.jpg" width="400" alt="A version of the 'What am I reading' meme.">  
<caption><small>
...
<img src="../img/ai/big-picture.png" width="400" alt="A representation of the phrase 'Seeing the Bigger Picture'.">  
<caption><small>
...
<img src="../img/ai/hammer.jpg" width="400" alt="A Hammer Being Held.">  
<caption><small>
...
<i>This essay was revised and updated on August 12, 2026.</i> 